...
- Dirty branch-state unsigned x64 candidates were built and inspected at versions 1.0.0.0 and 1.0.0.1 before the final test-hook path hardening. Their SHA-256 values are `1b507b7e48aabfbfb78ce3c3ebaac92ddb71b5f1920c31d9f1c0f5cbecb8bae0` and `f7fb2dae340b9be1dd85a6f2d7bc7a9b5a105804ffc13e2203e5455540074810`. Both contain only the reviewed `runFullTrust` capability, the disabled startup task, the requested x64 identity, no signature, and no private-key material. The toolchain still lacks `mspdbcmf.exe`, so no symbols package was generated; a clean committed source candidate remains a later release Gate.
