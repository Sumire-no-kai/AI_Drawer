...
internal static class ProviderCatalog
{
    ...
    [
        ...
        Create("deepseek", "DeepSeek", "Experimental", "ms-appx:///Assets/Providers/deepseek.svg", "DS", "https://chat.deepseek.com/", ["chat.deepseek.com"], NoDomains),
        Create("doubao", "Doubao / 豆包 (China)", "Experimental", "ms-appx:///Assets/Providers/doubao.png", "豆", "https://www.doubao.com/", ["www.doubao.com"], ["feishu.cn", "bytedance.com"]),
        Create("qwen", "Qwen Studio (International)", "Experimental", "ms-appx:///Assets/Providers/qwen.png", "QW", "https://chat.qwen.ai/", ["chat.qwen.ai"], NoDomains),
