...
internal static class ProviderCatalog
{
    ...
    [
        CreateGemini(),
        Create("chatgpt", "ChatGPT", "Experimental", "ms-appx:///Assets/Providers/chatgpt.svg", "C", "https://chatgpt.com/", ["chatgpt.com"], ["auth.openai.com", "accounts.google.com"]),
        Create("claude", "Claude", "Experimental", "ms-appx:///Assets/Providers/claude.svg", "C", "https://claude.ai/", ["claude.ai"], ["accounts.google.com"]),
